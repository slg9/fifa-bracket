  ...
  return (
    <main className={`survival-arcade is-${mode}`}>
      <style>{`
        ...
        .survival-modal{position:fixed;inset:0;z-index:1500;display:grid;place-items:center;background:rgba(0,0,0,.55);padding:18px}.survival-modal__panel{width:min(92vw,340px);border:1px solid rgba(255,255,255,.16);border-radius:18px;background:rgba(4,10,20,.94);box-shadow:0 24px 70px rgba(0,0,0,.5);padding:14px;display:grid;gap:10px}.survival-modal__panel h2{margin:0;font:900 26px 'Barlow Condensed';letter-spacing:.1em;text-transform:uppercase}.survival-modal__panel button{min-height:46px;border-radius:13px;border:1px solid rgba(255,255,255,.14);background:rgba(255,255,255,.08);color:#fff;font:900 14px 'Barlow Condensed';letter-spacing:.12em;text-transform:uppercase}.survival-modal__panel button.is-primary{background:#2bff9a;color:#03120a;border-color:#2bff9a}.survival-volume{display:grid;grid-template-columns:auto 1fr auto;gap:10px;align-items:center;color:rgba(255,255,255,.78);font:800 12px Barlow,sans-serif}.survival-volume input{width:100%}
        ...
        <section className="survival-stage">
          <div className="survival-game-frame">
            <div className="survival-hud">
              <button type="button" className="survival-back" onClick={endRun}>Quitter</button>
